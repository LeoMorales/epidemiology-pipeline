...
# %%
#data = pandas.read_csv("../../_products/rates/departamental-rates.csv", dtype={'department_id': object})
data = pandas.read_csv(upstream['get-rates-departamental']["data"], dtype={'department_id': object})
...
# %%
data = utils.append_cell_description(data, departmentCodeColumn="department_id")
...
complete_df = (
    data[columns_order]
        .sort_values(
            by=["period", "age_group", "sex", "region_nombre", "provincia_nombre", "department_id"]
        )
