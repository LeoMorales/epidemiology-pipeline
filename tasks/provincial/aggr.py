...
def aggrCauseSpecificDeceasesAnnuallyBySexByAgeGroup(
    ...
    """Retorna las cantidades anuales de fallecimientos por causas específicas en para cada provincia (código), agrupadas por sex y grupo etario.
    ...
    workingColumns = ["codigo_defuncion", "sex", "year", "age_group", "provincia_id"]
    ...
    counts_df = (
        df.groupby(["year", "provincia_id", "sex", "age_group"])
        .count()
    ...
    output_df = (
        ...
        .sort_values(by=["year", "provincia_id", "sex", "age_group_order"])
