...
def get_clean_population_province_age_group(product):
    """Retorna los datos de población total, varones y mujeres obtenidos desde un excel inicial.
    Los datos corresponden a grupos etarios por cada provincias, para los años 2010 al 2040
    ...
    for province_sheet_name in sheet_names:
        ...
        # population_df[["province_id", "province_description"]] = province_sheet_name.split("-")
        population_df["province_id"] = province_sheet_name.split("-")[0]
