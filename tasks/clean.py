...
def get_cleaned_data_1991_2017(product, upstream):
    ...
    df_1991_2000['provincia_id'] = \
        cleaning.rewrite_province_codes(df_1991_2000['provincia_residencia'].astype(int))

    df_1991_2000['department_id'] = \
        cleaning.rewrite_department_codes(
            df_1991_2000['departamento_residencia'].astype(int),
            df_1991_2000['provincia_id'])

    df_2001_2014['provincia_residencia_clean'] = df_2001_2014['provincia_residencia'].str.replace(".0", "", regex=False)
    df_2001_2014['departamento_residencia_clean'] = df_2001_2014['departamento_residencia'].str.replace(".0", "", regex=False)

    df_2001_2014['provincia_id'] = \
        cleaning.rewrite_province_codes(df_2001_2014['provincia_residencia_clean'])

    df_2001_2014['department_id'] = \
        cleaning.rewrite_department_codes(
            df_2001_2014['departamento_residencia_clean'],
            df_2001_2014['provincia_id'])

    df_2015_2017['provincia_residencia_clean'] = df_2015_2017['provincia_residencia'].str.replace(".0", "", regex=False)
    df_2015_2017['departamento_residencia_clean'] = df_2015_2017['departamento_residencia'].str.replace(".0", "", regex=False)

    df_2015_2017['provincia_id'] = \
        cleaning.rewrite_province_codes(df_2015_2017['provincia_residencia_clean'])

    df_2015_2017['department_id'] = \
        cleaning.rewrite_department_codes(
            df_2015_2017['departamento_residencia_clean'],
            df_2015_2017['provincia_id'])

    # months cleanning:
    
    df_2015_2017['mes_defuncion'] = df_2015_2017['mes_ano_defuncion'].str.slice(0, 2)
    df_2001_2014['mes_defuncion'] = df_2001_2014['fecha_defuncion'].str.split("/").str[1]
    ...
    df_1991_2000.loc[dates_with_3_digits, 'mes_defuncion'] = \
        '0' + df_1991_2000.loc[dates_with_3_digits, 'fecha_defuncion'].str.slice(0, 1)
    ...
    meses_que_han_quedado_de_un_digito = \
        df_1991_2000['mes_defuncion'].str.len() == 1

    fecha_tiene_4_digitos = \
        df_1991_2000['fecha_defuncion'].str.len() == 4

    condition = meses_que_han_quedado_de_un_digito & fecha_tiene_4_digitos

    df_1991_2000.loc[condition, 'mes_defuncion'] = \
        df_1991_2000.loc[condition, 'fecha_defuncion'].str.slice(0,2)
    ...
    df_1991_2000.loc[mes_con_un_solo_digito, 'mes_defuncion'] =\
        df_1991_2000.loc[mes_con_un_solo_digito, 'mes_defuncion'].str.zfill(2)
    ...
    df_2001_2014.loc[no_bar_and_len_8, "mes_defuncion"] = \
        df_2001_2014.loc[no_bar_and_len_8, "fecha_defuncion"].str.slice(4, 6)
    ...
    df_2001_2014.loc[has_bar_and_not_valid_month, 'mes_defuncion'] =\
        df_2001_2014.loc[has_bar_and_not_valid_month, 'fecha_defuncion'].str.split("/").str[0]
    ...
    df_2015_2017.loc[contains_hyphen, 'mes_defuncion'] = \
        df_2015_2017\
            .loc[contains_hyphen, 'mes_ano_defuncion']\
            .str.split('-').str[0]\
