...
WORK_COL = ['codigo_defuncion', 'sex', 'age_in_years', 'department_id', 'provincia_id', 'year']
...
for edad_base, edad_tope in rangos_etarios:
    ...
    for year_a, year_b in rangos_etarios_de_un_anio:
        ...
        df["provincia_nombre"] = df["provincia_id"].apply(utils.PROVINCE_NAME_BY_ID.get)
